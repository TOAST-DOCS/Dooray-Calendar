...
### CalDAV 설정
Dooray 캘린더 일정을 CalDAV 설정하여 이용하시려면, 연동하시려는 캘린더 클라이언트의 CalDAV 계정 추가(설정) 화면에 CalDAV 설정 정보를 등록하시면 됩니다. CalDAV 설정에 필요한 정보는 Dooray 설정 > 캘린더 > CalDAV 메뉴에서 확인하실 수 있습니다. 참고로, CalDAV 비밀번호는 두레이 로그인시 사용하는 비밀번호가 아닌, CalDAV용으로 새롭게 발급된 비밀번호이니 CalDAV 메뉴에서 확인하고 입력해 주세요. 비밀번호는 변경이 필요한 경우 언제든지 해당 메뉴에서 새로운 비밀번호를 발급받아 이용할 수 있습니다.
